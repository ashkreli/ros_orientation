...
def plot_performance(s_refs_og, u_refs_og, S_traj, U_traj, S_evol, U_evol):
    """ Return system evolution applying noise to DARE LQR controller """
...
# Generated a spline-interpolated time-parametrized trajectory
waypts = [np.array([[1], [1]]), 
          np.array([[2], [4]]), 
          np.array([[5], [2]]), 
          np.array([[6], [6]])]
...
# Spline-interpolated Trajectory
...
S_spl_traj, U_spl_traj, S_spl_evol, U_spl_evol = plot_performance(s_refs_og_spl, 
                                                                  u_refs_og_spl, 
                                                                  S_spl_traj, 
                                                                  U_spl_traj, 
                                                                  S_spl_evol, 
...
S_cir_traj, U_cir_traj, S_cir_evol, U_cir_evol = plot_performance(s_refs_og_cir, 
                                                                  u_refs_og_cir, 
                                                                  S_cir_traj, 
                                                                  U_cir_traj, 
                                                                  S_cir_evol, 
...
S_lin_traj, U_lin_traj, S_lin_evol, U_lin_evol = plot_performance(s_refs_og_lin, 
                                                                  u_refs_og_lin, 
                                                                  S_lin_traj, 
                                                                  U_lin_traj, 
                                                                  S_lin_evol, 
...
ax.legend((l1, l2, l3), 
          ('Reference', 
           'State with Trajectory Tracking (DARE)', 
           'State with Evolving Reference Point (DARE)'), 
           loc='upper right', 
           shadow=True)
ax.set_xlabel('x')
ax.set_ylabel('y')
